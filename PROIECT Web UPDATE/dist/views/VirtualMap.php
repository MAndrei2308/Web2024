    ...
    <div class="container">
        ...
        <map name="euromap">
            <area shape="poly"
                  ...
                  href="Category.php#franta" alt="Franta">
            <area shape="poly"
                  ...
                  href="Category.php#germania" alt="Germania">
            <area shape="poly"
                  ...
                  href="Category.php#italia" alt="Italia">
            <area shape="poly"
                  ...
                  href="Category.php#romania" alt="Romania">
            <area shape="poly"
                  ...
                  href="Category.php#spania" alt="Spania">
        </map>
    </div>
