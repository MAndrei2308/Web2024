...
<head>
    ...
    <link rel="stylesheet" href="../css/VirtualMapDesign.css">
...
<body>
    ...
    <div class="container">
        <img src="../../img/europa.png" class="container__image" alt="Harta Europei" usemap="#euromap">
        <map name="euromap">
            <area shape="poly"
                  ...
                  href="../controllers/CategoryController.php#france" alt="Franta">
            <area shape="poly"
                  ...
                  href="../controllers/CategoryController.php#germany" alt="Germania">
            <area shape="poly"
                  ...
                  href="../controllers/CategoryController.php#italy" alt="Italia">
            <area shape="poly"
                  ...
                  href="../controllers/CategoryController.php#romania" alt="Romania">
            <area shape="poly"
                  ...
                  href="../controllers/CategoryController.php#spain" alt="Spania">
        </map>
    </div>
