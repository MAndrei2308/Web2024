    ...
    <div class="container">
        ...
        <map name="euromap">
            <area shape="poly"
                ...
                href="Conectat_Category.html#franta" alt="Franta">
            <area shape="poly"
                ...
                href="Conectat_Category.html#germania" alt="Germania">
            <area shape="poly"
                ...
                href="Conectat_Category.html#italia" alt="Italia">
            <area shape="poly"
                ...
                href="Conectat_Category.html#romania" alt="Romania">
            <area shape="poly"
                ...
                href="Conectat_Category.html#spania" alt="Spania">
        </map>
    </div>
