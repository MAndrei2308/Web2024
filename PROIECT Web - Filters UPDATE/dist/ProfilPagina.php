...
<body>
    ...
    <div class="profile-container">
        ...
        <div class="profile-container__leftbox">
            <nav>
                <a href="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/profil.php" class="nav__user">
                    <img src="../img/profile-user.png" alt="Profile" class="nav__button-user">
                </a>
                <a href="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/favorite.php">
                    <img src="../img/iconheart-rose.png" alt="Favorite" class="nav__button-favorite">
                </a>
                <a href="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/logout.php">
                    <img src="../img/logout.png" alt="Logout" class="nav__button-logout">
                </a>
                <a href="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/home.php">
        ...
        <div class="profile-container__rightbox">
            <div class="profile">
                ...
                <form action="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/update.php" method="post">
