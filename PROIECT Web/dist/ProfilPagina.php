    ...
    <div class="profile-container">
        ...
        <div class="profile-container__rightbox">
            <div class="profile">
                ...
                <form action="php/update.php" method="put">
                    <p class="profile__info">
                        <label for="first_name"></label>
                        <input type="text" placeholder="<?php echo htmlspecialchars($first_name); ?>" name="first_name" id="first_name">
                        
                        <label for="last_name"></label>
                        <input type="text" placeholder="<?php echo htmlspecialchars($last_name); ?>" name="last_name" id="last_name">
                ...
                <form action="php/update.php" method="put">
                    <p class="profile__info">
                        ...
                        <input type="text" placeholder="<?php echo htmlspecialchars($username); ?>" name="username" id="username">
                ...
                <form action="php/update.php" method="put">
                    <p class="profile__info">
                        ...
                        <input type="text" placeholder="<?php echo htmlspecialchars($gender); ?>" name="gender" id="gender">
                ...
                <form action="php/update.php" method="put">
                    <p class="profile__info">
                        ...
                        <input type="text" placeholder="<?php echo htmlspecialchars($email); ?>" name="email" id="email">
