...
<body>
    <header>
        ...
        <div class="navbar__buttons">
            ...
            <label for="user" class="user-icon"><a href="../../../../../../../xampp/htdocs/PROIECT%20Web%20UPDATE/dist/views/profil.php"><img
    ...
    <div class="container">
        ...
        <form class="container__search-bar" action="views/FilteredProducts.php" method="POST">
